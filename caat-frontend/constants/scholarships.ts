export const TAG_COLORS: Record<string, string> = {
  ...
  "NEED-BASED":    "bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-300",
  "POST-GRAD":     "bg-indigo-100 text-indigo-700 dark:bg-indigo-900/30 dark:text-indigo-300",
  "INTERNATIONAL": "bg-orange-100 text-orange-700 dark:bg-orange-900/30 dark:text-orange-300",
